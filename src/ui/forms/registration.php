...
<form method="POST" class="flex flex-col absolute p-12 box-content inset-0 w-64 h-fit m-auto gap-4 rounded-lg shadow-lg" action="signup">
    ...
    <input type="text" name="firstname" class="<? echo $input_style ?>" placeholder="Имя"/>
    <input type="text" name="lastname" class="<? echo $input_style ?>" placeholder="Фамилия"/>
    <input type="password" name="password" class="<? echo $input_style ?>" placeholder="Пароль"/>
    <input type="password" name="password_confirm" class="<? echo $input_style ?>" placeholder="Повторите пароль"/>
