...
<form method="POST" class="flex flex-col bg-white absolute p-12 box-content inset-0 w-64 h-fit m-auto gap-4 rounded-lg shadow-lg" action="user/signup">
    ...
    <input type="text" name="firstname" class="<?= $input_style ?>" placeholder="Имя" required/>
